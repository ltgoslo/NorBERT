...
--train_path \
/cluster/work/projects/nn9851k/mariiaf/hplt/deu_Latn/tokenized_shards_32/train \
--tokenizer_path /cluster/work/projects/nn9851k/mariiaf/hplt/deu_Latn/tokenizer.json \
--output_dir /cluster/work/projects/nn9851k/mariiaf/hplt/deu_Latn/norbert_8_nodes \
--dataset_weights 1.0 \
--name NorBERT4_base_deu_Latn_8_nodes \
--max_steps 31250 \
...
--optimizer muon \
--experiment NorBERT4_base_deu_Latn_8_nodes \
